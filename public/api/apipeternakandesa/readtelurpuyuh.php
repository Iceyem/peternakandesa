...
$query = $link->query("SELECT id, namaproduk, berat, isi, harga, gambar FROM telurpuyuh ORDER BY id ASC");
$result = array();
...
if ($query) {
    ...
    while ($rowData = $query->fetch_assoc()) {
        // Mengonversi BLOB gambar ke base64
        $rowData['gambar'] = base64_encode($rowData['gambar']);
        $result[] = $rowData;
    }
